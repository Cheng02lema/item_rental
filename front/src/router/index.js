...
const routes = [
  {
    ...
    },
    {
      path: '/itemlist',
      name: 'ItemList',
      component: () => import("../components/admin/itemList.vue"),  //物品列表
    }, {
      path: '/edit',
      component: () => import("../components/admin/edititem.vue")
    },
    {
      path: '/additem',
      name: 'Additem',
      component: () => import("../components/admin/additem.vue"), //添加物品
    },
    {
      path: '/zulist',
      name: 'Zulist',
    ...
    },
    {
      path: '/applylist',
      name: 'Applylist',
      component: () => import("../components/admin/applylist.vue") //物品预约
    },
    {
      path: '/applyout',
      name: 'Applyout',
  ...
  },
  {
    ...
    },
    {
      path: '/uitemlist',
      name: 'uitemList',
      component: () => import("../components/zuke/itemList.vue"),  //物品列表
    },
    {
      path: '/uapplyitem',
      name: 'uApplyitem',
      component: () => import("../components/zuke/applyitem.vue"),  //物品列表
    },
    {
      path: '/uzulist',
      name: 'uZulist',
    ...
    },
    {
      path: '/uapplylist',
      name: 'uApplylist',
      component: () => import("../components/zuke/applylist.vue") //物品预约
    },
    {
      path: '/uapplyout',
      name: 'uApplyout',
  ...
  // }
  {
    path:'/zuindex',
    name:'zuindex',
    component: ()=>import("../components/index/zuindex.vue")
  }
