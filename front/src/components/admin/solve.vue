  ...
  <div class="wrapper">
    ...
    >
      ...
      <el-table-column
        ...
        width="180"
      />
      <el-table-column align="center" prop="iname" label="名称" />
      <el-table-column align="center" prop="date" label="投诉日期" />
...
const deletes = () => {
  let list = [];
  multipleSelection.value.forEach((item) => list.push(item.item_id));
  console.log(list);
  // 调用ajax 批量删除
